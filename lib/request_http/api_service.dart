...
Future<AppResponse> postHTTP({
  ...
  throw ApiException(AppResponse(statusCode: 502, body: noInternetConnectionError()));
}


Future<AppResponse> putHTTP({required String endpoint, Map<String, String>? parameters, Map<String, dynamic>? body}) async {
  if (await thereInternetConnection()) {
...
Future<AppResponse> deleteHTTP({required String endpoint, Map<String, String>? parameters}) async {
  if (await thereInternetConnection()) {
